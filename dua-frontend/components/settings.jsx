    ...
    <div className="">
      ...
      <div className="text-[#868686] p-4">
        <details className="group w-full rounded-2xl">
          <summary className="relative flex gap-3 bg-[#F7F8FA] px-3 py-2  items-center  cursor-pointer list-none  transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
        ...
        <details className=" group w-full rounded mt-4">
          <summary className="relative flex gap-2 bg-[#F7F8FA] px-3 py-2 items-center  cursor-pointer list-none  transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
            <Image src={setting} alt="setting" />
        ...
        <details className="group w-full rounded mt-4" open>
          ...
          <div className="py-4 px-2 shadow text-gray-700 flex justify-between items-center">
